...
//A while loop that prints every second value descending from 100
    ...
    println("End of continue")

    //Kotlin when expression with block of code
    var day = 2
    ...
    //Range in when condition
    when (day) {
        in 1..5 -> println("Weekday")
        in 5..6 -> println("Weekday") // else
    }
    ...
    var fruits = arrayOf("Mango", "Orange", "Banana", "Apple")
